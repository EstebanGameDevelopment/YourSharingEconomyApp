...
namespace YourSharingEconomyApp
{
	...
	public class CommController : StateManager
	{
		...
		public const string EVENT_COMM_BITCOIN_REGISTER_TRANSACTION = "EVENT_COMM_BITCOIN_REGISTER_TRANSACTION";
		 ...
		 */
		public void RequestUpdateProfile(string _idUser, string _currentPassword, string _password, string _email, string _name, string _village, string _mapdata, string _skills, string _description, string _publicKeyAddress)
		{
			Request(EVENT_COMM_REQUEST_UPDATE_PROFILE, _idUser, _currentPassword, _password, _email, _name, _village, _mapdata, _skills, _description, _publicKeyAddress);
		}
		 ...
		 */
		public void UpdateRequestScoreAndFeedback(int _id, string _password, long _requestID, int _scoreConsumer, string _feedbackConsumer, int _scoreProvider, string _feedbackProvider, string _signatureCustomer, string _signatureProvider)
		{
			RequestPriority(EVENT_COMM_UPDATE_REQUEST_SCORE_AND_FEEDBACK, _id.ToString(), _password, _requestID.ToString(), _scoreConsumer.ToString(), _feedbackConsumer, _scoreProvider.ToString(), _feedbackProvider, _signatureCustomer, _signatureProvider);
		}
		 ...
		 */
		public void RequestUpdateTransactionBitcoin(int _idUser, string _password, long _requestId, string _transactionID)
		{
			Request(EVENT_COMM_BITCOIN_REGISTER_TRANSACTION, _idUser.ToString(), _password, _requestId.ToString(), _transactionID);
		}
		...
		private void RequestReal(string _event, params object[] _list)
		{
			...
			switch (m_event)
			{
				...
				case EVENT_COMM_BITCOIN_REGISTER_TRANSACTION:
					m_commRequest = new RequestUpdateTransactionHTTP();
					break;
			}
