...
namespace YourBitcoinManager
{
	...
	public class SlotManagerView: MonoBehaviour
	{
		...
		public void Initialize(int _itemsEachPage, List<ItemMultiObjects> _data, GameObject _slotPrefab, GameObject _createNewPrefab = null)
		{
			...
			{
				m_textLoading.GetComponent<Text>().text = YourSharingEconomyApp.LanguageController.Instance.GetText("message.loading");
			}
		...
		public void LoadCurrentPage()
		{
			...
			{
				if (m_imageLoading != null) m_imageLoading.gameObject.SetActive(true);
				if (m_textLoading != null) m_textLoading.GetComponent<Text>().text = YourSharingEconomyApp.LanguageController.Instance.GetText("message.no.records");
			}
			else
			{
