...
public class UsersController : MonoBehaviour
{
    ...
    public const string EVENT_USER_UPDATE_VILLAGE                   = "EVENT_USER_UPDATE_VILLAGE";
    ...
    private void OnBasicEvent(string _nameEvent, params object[] _list)
    {
        ...
        if (_nameEvent == UsersController.EVENT_USER_UPDATE_PROFILE_REQUEST)
        {
            ...
            CommController.Instance.RequestUpdateProfile(idUser, UsersController.Instance.CurrentUser.PasswordPlain, newPassword, newEmail, newNameUser, newVillage, newMapData, newSkills, newDescription);
        }
