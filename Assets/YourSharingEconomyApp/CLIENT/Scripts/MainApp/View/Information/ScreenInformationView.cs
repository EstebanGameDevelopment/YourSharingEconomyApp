...
namespace YourSharingEconomyApp
{
	 ...
	 */
	public class ScreenInformationView : ScreenBaseView, IBasicScreenView
	{
		...
		private void OkPressed()
		{
			...
			BasicEventController.Instance.DispatchBasicEvent(EVENT_SCREENINFORMATION_CONFIRMATION_POPUP, this.gameObject, true, m_pagesInfo[m_page].EventData);
			Destroy();
		}
		...
		{
			BasicEventController.Instance.DispatchBasicEvent(EVENT_SCREENINFORMATION_CONFIRMATION_POPUP, this.gameObject, false, m_pagesInfo[m_page].EventData);
			Destroy();
		}
		...
		private void ChangePage(int _value)
		{
			...
			else
			{
				...
				BasicEventController.Instance.DispatchBasicEvent(EVENT_SCREENINFORMATION_CHANGED_PAGE_POPUP, this.gameObject, m_pagesInfo[m_page].EventData);
			}
		}
